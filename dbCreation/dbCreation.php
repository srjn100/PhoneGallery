...
email VARBINARY(70) NOT NULL UNIQUE,
userName VARBINARY(70) NOT NULL UNIQUE,
password VARBINARY(70) NOT NULL,
firstName VARCHAR(20) NOT NULL,
lastName VARCHAR(20) NOT NULL,
regDate TIMESTAMP NOT NULL,
userImagePath VARBINARY(200),
isAdmin BOOLEAN NOT NULL)";

$sql[]="CREATE TABLE BRANDS(
brandID INT PRIMARY KEY AUTO_INCREMENT,
brandName VARCHAR(20) NOT NULL UNIQUE,
brandImagePath VARBINARY(200),
...
rating INT NOT NULL,
review VARBINARY(5000) NOT NULL,
userID INT NOT NULL,
FOREIGN KEY(userID) REFERENCES USERS(userID),
phoneID INT NOT NULL,
FOREIGN KEY(phoneID) REFERENCES PHONES(phoneID) ON DELETE CASCADE)";
