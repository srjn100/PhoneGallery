...
if (isset($_POST['submit'])) {
    $text = 'hello ';
    $rate = 'hi ';
    if (isset($_POST['text']) and !empty($_POST)) {
        $text = $_POST['text'];
    }
    if (isset($_POST['rate'])) {
        $rate = $_POST['rate'];
...
where brandID='$bid' AND isActive='1'";
...
limit 9";
    ...
    $brs = mysqli_query($conn, "SELECT brandName from brands where brandID='$bid'");
    ...
    <div class="third">
        ...
        <div class="thirdS">
            <div class="thirdSFirst">
                <h4 class="d-flex justify-content-center"><?php echo strtoupper($bdt[0]) ?> PHONES</h4>
            </div>
