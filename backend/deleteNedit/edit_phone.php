...
$phoneID1=$_GET['phoneID'];
$prs=mysqli_query($conn,"SELECT * FROM phones WHERE phoneID='$phoneID1'");
$pd=mysqli_fetch_row($prs);
$brs=mysqli_query($conn,"SELECT brandName FROM brands WHERE brandID='$pd[7]'");
$bdt=mysqli_fetch_row($brs);
...
if(isset($_POST['submit'])) {
    ...
    if(count($err)==0){
        $delPath="../../files/brands/$bdt[0]/$pd[1]";
        ...
        if(!file_exists($imgDir))
            ...
            elseif(move_uploaded_file($_FILES['phoneImage']['tmp_name'],$newFile)){
                $psql="UPDATE phones SET phoneName='$phoneName',phoneModel='$phoneModel',
                releaseDate='$releaseDate',userID='$id',brandID='$brandID',thumbnail='$fileDBpath' WHERE phoneID='$phoneID1'";

                if(mysqli_query($conn,$psql)){
                    echo "<script> alert(\"phone edited\");</script>";
...
<div class="container">
    ...
    <div class="body">
        ...
        <div class="content">
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']."?id=$id&phoneID=$phoneID1"?>" enctype="multipart/form-data">
                <div class="phone-form">
                    <div class="phone-head">
                        <h1 class="phone-h1">
                            <span class="login-heading">Phone Edit Form</span>
                        </h1>
                    </div>
                    <div class="phone-input">
                        <fieldset class="input-frame" >
                            ...
                            <div class="input" >
                                <input type="text" name="phoneName" placeholder="Phone Name" value="<?php echo $pd[1]?>">
                            </div>
                        </fieldset>
                    </div>
                    <div class="error">
                ...
                <?php if(isset($err['phoneName']))echo $err['phoneName'];?>
                    ...
                    <div class="phone-input">
                        <fieldset class="input-frame" >
                            ...
                            <div class="input" >
                                <input type="text" name="phoneModel" placeholder="Phone Model" value="<?php echo $pd[2]?>">
                            </div>
                        </fieldset>
                    </div>
                    <div class="error">
                ...
                <?php if(isset($err['phoneModel']))echo $err['phoneModel'];?>
                    ...
                    <div class="phone-input">
                        <fieldset class="input-frame" >
                            ...
                            <div class="input" >
                                <input type="date" name="releaseDate" value="<?php echo $pd[4]?>">
                            </div>
                        </fieldset>
                    </div>
                    <div class="error">
