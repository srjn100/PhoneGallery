...
?>
<?php
$brandName1=$_GET['brandName'];
$brandID1=$_GET['brandID'];
$brandName='';
$err=[];
if(isset($_POST['submit'])){
    ...
    if(count($err)==0){
        ...
        if($res=mysqli_query($conn,$upsql)){
            $bd=mysqli_fetch_row($res);
            $delPath="../../files/brands/$brandName1";
                ...
                if(!file_exists($imgDir))
                    ...
                    elseif(move_uploaded_file($_FILES['brandImagePath']['tmp_name'],$newFile)){
                        $upsql1="UPDATE brands
                                SET brandName='$brandName',brandImagePath='$fileDBpath',userID='$id'
                                 WHERE brandID='$brandID1'";
...
<div class="container">
    ...
    <div class="body">
        ...
        <div class="content">
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']."?id=$id&brandName=$brandName1&brandID=$brandID1"?>" enctype="multipart/form-data">
                <div class="brand-form">
                    <div class="brand-head"><h1 class="login-h1">
                            <span class="login-heading">Brand Edit Form</span>
                        </h1></div>
                    <div class="brand-input">
                        <fieldset class="input-frame" >
                            <legend class="l" >Enter Brand Name</legend>
                            <div class="input" >
                                <input type="text" name="brandName" placeholder="Brand Name" value="<?php echo $brandName1?>">
                            </div>
                        </fieldset>
                    </div>
