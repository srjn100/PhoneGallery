...
if(mysqli_num_rows($ares)==1) {
    ...
    if ($pres = mysqli_query($conn, $sql)) {
        if (mysqli_num_rows($pres) > 0) {
            ...
            foreach ($pd as $r) {
                $sop .= "<option value=\"$r[0]\" id='brandOP'>$r[1]</option>";
            }
        } else {
...
if(isset($_POST['submit'])){
    if($_POST['phoneID']=='-1'){
        $err['phoneID']="brand not selected";
    }
    else{
...
<div class="container">
    ...
    <div class="body">
        ...
        <div class="content">
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']."?id=$id&bid=$brandID"?>" enctype="multipart/form-data">
            ...
            <div class="self" id="self-menu">
                ...
                <div class="sub-menu" id="image-menu">
                    <a href="image_insert.php?id=<?php echo $id;?>" class="sub-menu-item">
                        <i class="fas fa-arrow-down fa-1x active"></i>
                        <span class="active">INSERT</span>
                    </a>
