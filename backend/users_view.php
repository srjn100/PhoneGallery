...
WHERE userID = '$id'";
    ...
    $avsql="SELECT * FROM users
            WHERE isAdmin=0";
    $avres = mysqli_query($conn, $avsql);
    if (mysqli_num_rows($avres) > 0) {
        $data1 = mysqli_fetch_all($avres);
    }
}
else
...
<div class="container">
    ...
    <div class="body">
        <div class="side-nav">
            ...
            <a href="users_view.php?id=<?php echo $id?>" class="menu-item active">
                <i class="fas fa-user-alt fa-2x"></i>
                <span>USERS</span>
            </a>
        </div>
        <div class="content">
            <div class="h1"><h1>USERS LIST</h1></div>
            <div class="table">
                <?php
                //print_r($data1);
                ?>
                <table>
                    ...
                    $style="style=\"background:#F2F2F2\"";
                        ...
                        foreach ($data1 as $r){
                            ...
                            echo "<td><a href=\"mailto:".$r[1]."\"><span class='action'>MAIL</span></a>";
                            echo "</tbody>";
                        }
                    ?>
                </table>
